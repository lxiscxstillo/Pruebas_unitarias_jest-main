          ...
          <div className="text-center">
            ...
            <div className="flex gap-4 justify-center my-8">
              {[1, 2, 3, 4, 5].map((rating) => (
                <label 
                  key={rating} 
                  className="relative flex items-center justify-center w-16 h-16 cursor-pointer transform hover:scale-110 transition-all duration-300"
                >
                  <input
                    type="radio"
                    name="rating"
            ...
            <div className="flex gap-4 justify-center">
              ...
              <button
                onClick={handleReset}
                className="px-6 py-3 rounded-xl bg-white/10 text-blue-200 shadow-lg hover:bg-white/20 transform hover:scale-105 transition-all duration-300"
              >
                Reiniciar
              </button>
            </div>
